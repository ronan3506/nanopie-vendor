...
const slides = [
  {
    ...
    sub: 'Nanopie connects local businesses with micro-investors who believe in your vision.',
    bg: '#16232B',
    accent: '#FF5B04',
    textColor: '#E4EEF0',
    illustration: 'growth',
  },
  {
    ...
    sub: 'Create a funding request in minutes. Your community funds your next milestone.',
    bg: '#075056',
    accent: '#FF5B04',
    textColor: '#E4EEF0',
    illustration: 'fund',
